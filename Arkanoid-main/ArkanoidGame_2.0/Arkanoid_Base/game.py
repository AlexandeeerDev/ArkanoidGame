    ...
    def game_loop(self, difficulty, button_positions, font, small_font, connection, user_id):
        ...
        while running:
            ...
            if self.game_over:
                ...
                database.save_movements(connection)
...
def show_message(window, font, message):
    ...
    draw_text_centered(message_lines[0], font, RED, window, WINDOW_WIDTH // 2, GAME_AREA_HEIGHT // 2 - 50)

    # Si hay una segunda línea, mostrarla más abajo
    if len(message_lines) > 1:
        draw_text_centered(message_lines[1], font, RED, window, WINDOW_WIDTH // 2, GAME_AREA_HEIGHT // 2 + 50)
